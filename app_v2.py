...
# --- CONFIGURACIÓN ---
st.set_page_config(page_title="SolarResilience Pro", page_icon="⚡", layout="wide")
...
# Título Principal
st.title("⚡ SolarResilience: Diseño de Microgrids")
...
tab1, tab2, tab3 = st.tabs(["📊 Dashboard de Diseño", "📐 Explicación Técnica", "🛠️ Detalles de Equipos"])
